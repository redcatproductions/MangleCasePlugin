...
public class DecorateWithQuoteActionDelegate extends ActionDelegate implements
		IEditorActionDelegate, IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		if (editorPart instanceof ITextEditor)
		{
			...
			addQuotes(selection, editor);
		}
	}

	private void addQuotes(	final ITextSelection selection,
